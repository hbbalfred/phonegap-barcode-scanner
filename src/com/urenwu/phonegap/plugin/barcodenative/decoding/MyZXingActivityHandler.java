...
import com.urenwu.phonegap.plugin.barcodenative.view.*;
 ...
 */
public final class MyZXingActivityHandler extends Handler {

  private static final String TAG = MyZXingActivityHandler.class.getSimpleName();
  ...
  public MyZXingActivityHandler(MyZXingActivity activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
